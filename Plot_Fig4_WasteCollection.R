...
###----- NAME: --------------------------------------------------------------###
###                                                                          ###
### Plot_Fig4_WasteCollection.R                                              ###
###                                                                          ###
###----- AIM: ---------------------------------------------------------------###
###                                                                          ###
### Plot the best model for the waste collection coverage and quality        ###
...
###      The predicted values according to each model that converged.        ###
###   'Dep'            - Name of dependent.                                  ###
###   'Exp'            - Name of explanatory.                                ###
###   'ModName'        - Name of the model.                                  ###
###   'Exp___ModName'  - Exp and model name, separated by "___".             ###
...
Name     <- "VelisEtAl_Fig4_WasteCollection"

Dep1 <- "CollectionCoverage" 
Dep2 <- "WasteQualityCollection"
 
###--------------------------------------------------------------------------###
### 3.2.  Axis / Strip labels.

LabX1 <- "USD '000 (log scale)"    
LabY1 <- "I-1.1: Waste collection coverage"
Label1 <- "A) Coverage: GDP PPP per capita" 

LabX2 <- "CPI"    # set below
LabY2 <- "I-1C: Quality of waste collection service"
Label2 <- "B) Quality: Corruption perceptions index"    

LabX3  <- "I-1.1: Waste collection coverage"
LabY3  <- "I-1C: Quality of waste collection service"
Label3 <- "C) Quality vs. coverage"
...
###--------------------------------------------------------------------------###
### 5.2   Subset plotting data for observed and predicted. Set fill and border colors. 
...
# P1_Text <- c(LimX1[1]   + TextXProp * (LimX1[2]   - LimX1[1]), 
#              RangeY1[1] + TextYProp * (RangeY1[2] - RangeY1[1]))
...
###--------------------------------------------------------------------------###
### 6.2   Subset plotting data for observed and predcited. Set fill and border colors. 
...
# P2_Text <- c(LimX2[1]   + TextXProp * (LimX2[2]   - LimX2[1]), 
#              RangeY2[1] + TextYProp * (RangeY2[2] - RangeY2[1]))
...
###--------------------------------------------------------------------------###
### 9.5.  Prediction interval, ribbon + lower and upper lines.
...
###--------------------------------------------------------------------------###
### 9.6.  Confidence interval, ribbon + lower and upper lines.
...
P1 <- P1 + coord_cartesian(ylim = RangeY1, expand= c(0,0))
...
###--------------------------------------------------------------------------###
### 10.5.  Prediction interval, ribbon + lower and upper lines.
...
###--------------------------------------------------------------------------###
### 10.6.  Confidence interval, ribbon + lower and upper lines.
...
P2 <- P2 + coord_cartesian(ylim = RangeY2, expand= c(0,0))
